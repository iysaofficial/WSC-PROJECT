...
import logo from "./../../public/assets/logo/WSC.png";

const Navigation = () => {
  const [menuOpen, setMenuOpen] = useState(false);
  const [siteBrandText, setSiteBrandText] = useState(
    window.innerWidth < 426 ? "WSC" : "WORLD SCIENCE COMPETITION"
  );
